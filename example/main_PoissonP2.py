# -*- coding: utf-8 -*-
"""
Created on Sat May 23 14:53:29 2020
...
# Poisson func
from fem.Poisson import PoissonP2
...
for k in range(maxIt):
    ...
    NT = elem.shape[0];
    h[k] = 1/np.sqrt(NT);
    ErrL2[k] = getL2error(node, elem, uh, u, 'P2', 4 ); # args 是元组
    ErrH1[k] = getH1error(node, elem, uh, Du, 'P2', 4 );    
